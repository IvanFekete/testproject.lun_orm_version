	...
	<body>
		...
		<div class = 'container'>
			<?php
				...
				if(array_key_exists('locality_id', $_POST)) {
					$id = $_POST['locality_id'];
					$locality = LocalityManage::find($id);
					...
					echo"
						...
						<input type = 'hidden' name = 'id' value = 'edit_locality' />
						<input type = 'hidden' name = 'locality_id' value = '".$id."' />
